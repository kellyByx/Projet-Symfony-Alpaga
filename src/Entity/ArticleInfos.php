...
/**
 * @ORM\Entity(repositoryClass=ArticleInfosRepository::class)
 */
class ArticleInfos
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Membre::class, inversedBy="articlesInfos")
    ...
    public function setMessageInfo(string $messageInfo): self
    {
